        ...
        <div className='container' style={{ minHeight: '600px' }}>
          ...
          <div className='row d-flex justify-content-center align-items-center mt-5'>
            <div className='alert alert-dismissible alert-success mt-5'>
              ...
              <strong>Thank you for registering with us!</strong> <br />
              Please enter the verification token received in your email or
...
export default connect(mapStateToProps, { getCsrfToken, verifyEmailToken })(
