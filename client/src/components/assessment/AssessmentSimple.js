            ...
            <Col sm='12' md={{ size: 6, offset: 3 }}>
              <form onSubmit={this.onSubmit}>
                ...
                <input
                  ...
                  //   error={errors.uRelationship}
                  id='uRelationship'
                  placeholder='uRelationship (Provided by your workplace)'
                  style={{
                    fontFamily: 'Montserrat',
                    color: 'grey',
                    'font-size': '17px',
                ...
                {/* <span className="red-text">
                          {errors.uRelationship}
                          {errors.uRelationshipnotfound}
                        </span>  */}
                ...
                <input
                  onChange={this.onChange}
                  // name = 'uRelationship'
                  // ref={input => this.uRelationship = input}
